...
class TestUtils(unittest.TestCase):
    def test_parse_iso8601(self):
        ...
        self.assertEqual(
            utils.parse_iso8601("2016-07-20T14:06:07"),
            datetime.datetime(2016, 7, 20, 14, 6, 7),
        )
        # Microseconds
        self.assertEqual(
            utils.parse_iso8601("2016-07-20T14:06:07.608319"),
            datetime.datetime(2016, 7, 20, 14, 6, 7, 608319),
        )
        # Space separator
        self.assertEqual(
            utils.parse_iso8601("2016-07-20 14:06:07"),
            datetime.datetime(2016, 7, 20, 14, 6, 7),
        )
    ...
    def test_format_filesize(self):
        ...
        self.assertEqual(format_filesize(10 * 1024), "10.0 kB")
        self.assertEqual(format_filesize(12.4 * 1024 * 1024), "12.4 MB")
